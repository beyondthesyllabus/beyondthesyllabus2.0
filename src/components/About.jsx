    ...
    <section id="about" ref={sectionRef} className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 flex flex-col items-center text-center">
        <div className="w-full max-w-4xl mt-6">
          ...
          {/* Paragraph 1 */}
          <p className={`text-lg md:text-xl leading-relaxed text-gray-800 mb-8 font-medium transition-all duration-1000 delay-300 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-16 opacity-0'}`}>
          ...
          {/* Paragraph 2 */}
          <p className={`text-lg md:text-xl leading-relaxed text-gray-600 mb-16 transition-all duration-1000 delay-500 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-16 opacity-0'}`}>
          ...
          {/* Feature Cards Group */}
          <div className="flex flex-col sm:flex-row gap-8 justify-center overflow-hidden py-4">
